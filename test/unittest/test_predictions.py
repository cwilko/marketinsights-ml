...
class APITest(unittest.TestCase):
    ...
    def testEndToEndPredictionFromDataset(self):
        ...
        self.assertTrue(np.allclose(np.nansum(results), 3.124945995554477))
    ...
    def testEndToEndPredictionFromRawData(self):
        ...
        results = self.miassembly.get_predictions_with_raw_data(data, TRAINING_RUN_ID, debug=True)
    ...
    #@DeprecationWarning
    def _test_legacy_predictions(self):
