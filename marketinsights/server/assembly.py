...
from marketinsights.remote.ml import MarketInsights, Dataset
from marketinsights.remote.ibmcloud import CloudObjectStore
from marketinsights.model.ml import Model
...
class PredictionAssembly:
    ...
    def createModelInstance(self, model_id, features, labels):
        ...
        # Create ML model for prediction (not training)
        return Model(features, labels, model_config, training=False)
